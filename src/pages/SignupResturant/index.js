...
import { getStorage, ref, uploadBytes, getDownloadURL, storage, setDoc, doc, db, auth, createUserWithEmailAndPassword, getDocs, collection } from './../../config/firebase'
...
const LoginResturant = () => {
  ...
  const { sendResturantData } = bindActionCreators(actionCreators, dispatch)
